...
assert.ok(dashboard.includes('./v46-admin-nav.js?v=56.53'),'dashboard must use the current admin nav cache bust');

// V56.38 IA remains the contract; V56.39 only adds the occasion-identity destination/runtime.
assert.ok(nav.includes("const VERSION='56.53'"),'nav version must carry the current V56.39 shell');
...
assert.ok(enh.includes("const VERSION='56.53'"),'enhancements must retain the V56.38 IA implementation');
