...
const setThemeColor=active=>{const meta=document.querySelector('meta[name="theme-color"]');if(!meta)return;if(!meta.dataset.identityDefault)meta.dataset.identityDefault=meta.getAttribute('content')||'#FFFFFF';meta.setAttribute('content',active?'#065F46':meta.dataset.identityDefault)};

/* V56.46 rule: no decorative DOM injection. Existing UI receives semantic variant tags only.
   All seasonal scenery is CSS/SVG paint outside normal document flow. */
