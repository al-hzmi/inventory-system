...
const setThemeColor=active=>{const meta=document.querySelector('meta[name="theme-color"]');if(!meta)return;if(!meta.dataset.identityDefault)meta.dataset.identityDefault=meta.getAttribute('content')||'#FFFFFF';meta.setAttribute('content',active?'#0A5143':meta.dataset.identityDefault)};

/* V56.62: no decorative DOM injection. Existing UI receives semantic variant tags only.
