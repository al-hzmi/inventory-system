...
const ADMIN_PAGES=new Set(['admin-dashboard.html','command-center.html','control-center.html','inventory-analytics.html','admin-stocktake.html']);
...
/* V51 architecture: one administration entry + one global navigation shell.
   command-center is intentionally retired because its responsibilities overlap
   admin-dashboard/control-center and was the largest source of duplicated navigation. */
...
#v51-admin-shell{position:sticky;top:0;z-index:100500;background:rgba(255,255,255,.97);backdrop-filter:blur(16px);border-bottom:1px solid var(--v51-border);font-family:"IBM Plex Sans Arabic",system-ui,sans-serif;color:var(--v51-text)}
#v51-admin-shell *{box-sizing:border-box}.v51-shell-row{min-height:var(--v51-shell-h);max-width:1460px;margin:auto;display:flex;align-items:center;gap:10px;padding:8px 14px}.v51-brand{min-width:135px;text-decoration:none;color:var(--v51-text);display:flex;align-items:center;gap:10px}.v51-brand-mark{width:35px;height:35px;border-radius:11px;background:#1c1917;color:#fff;display:flex;align-items:center;justify-content:center;font-size:15px;font-weight:800}.v51-brand-copy b{font-size:14px;display:block}.v51-brand-copy span{font-size:9px;color:var(--v51-muted);display:block;margin-top:1px}.v51-nav{flex:1;display:flex;align-items:center;gap:4px;overflow-x:auto;scrollbar-width:none}.v51-nav::-webkit-scrollbar{display:none}.v51-item{height:42px;min-width:max-content;padding:0 11px;border:1px solid transparent;border-radius:11px;background:transparent;color:#57534e;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;font-size:10px;font-weight:700;white-space:nowrap;cursor:pointer}.v51-item:hover{background:#fafaf9;color:#1c1917}.v51-item.on{background:#fef3c7;color:#92400e;border-color:#fde68a}.v51-icon{font-size:13px;line-height:1}.v51-security{border-color:var(--v51-border);background:#fff}.v51-exit{width:40px;min-width:40px;padding:0;border-color:var(--v51-border);background:#fff;font-size:17px}.v51-exit:hover{background:#fef2f2;color:#b91c1c;border-color:#fecaca}
/* Remove all launchers injected by V45/V46/V49/V50. The unified shell is the only global admin navigation. */
...
/* The original admin dashboard was rendered as a modal on a black backdrop. Convert it into a normal page. */
...
/* Other admin tools keep their local tabs, but their duplicate page title/back row is removed. */
body.v51-control-center .top .topin,body.v51-inventory-analytics .top .topin{display:none!important}body.v51-control-center .top,body.v51-inventory-analytics .top{top:var(--v51-shell-h)!important}body.v51-control-center .app,body.v51-inventory-analytics .app{max-width:1460px!important}
@media(max-width:780px){:root{--v51-shell-h:108px}.v51-shell-row{min-height:108px;display:grid;grid-template-columns:1fr auto;gap:7px;padding:8px 10px}.v51-brand{min-width:0}.v51-nav{grid-column:1/-1;width:100%;order:3}.v51-item{height:38px;padding:0 10px;font-size:10px}.v51-security{margin-inline-start:auto}.v51-exit{grid-column:2;grid-row:1}.v51-brand-copy span{display:none}body.v51-admin-dashboard #root>div.fixed.inset-0>div:first-child{height:calc(100dvh - var(--v51-shell-h))!important;min-height:560px!important}}
`;
...
function openSecurity(){
  ...
  sc=document.createElement('script');sc.id='v51-security-loader';sc.src='./v48-admin-security.js?v=51.0-'+Date.now();sc.async=true;
...
function cleanupLegacy(){
  ['v45-command-tab','v45-messages-tab','v46-control-tab','v49-security-tab','v49-security-fallback','v50-inventory-tab'].forEach(id=>document.getElementById(id)?.remove());
}
function normalize(){
